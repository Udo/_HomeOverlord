...
weatherAndTimeUpdate = function() {
  ...
  var extInfo = document.weather.wscur+'km/h'; 
                
  if(!document.weatherInfoState) {
    document.weatherInfoState = true;
    extInfo = document.weather.description;
  } 
  else {
    document.weatherInfoState = false;
  }
